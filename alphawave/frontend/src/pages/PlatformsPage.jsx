      ...
      <section className="pt-20 pb-16 bg-primary relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-10 relative z-10">
          ...
          <p className="text-lg text-white/55 max-w-xl">
            MetaTrader 4, MetaTrader 5, TradingView, and our own AlphaWave Markets App — choose the platform that fits your style.
          </p>
        </div>
      </section>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-primary">
                  ...
                  {["MetaTrader 5", "MetaTrader 4", "TradingView", "AlphaWave Markets App"].map((h) => (
